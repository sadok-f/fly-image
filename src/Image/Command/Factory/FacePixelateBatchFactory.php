...
class FacePixelateBatchFactory
{
    /**
    ...
    public function build(...$options): CommandInterface
    {
        ...
        return new FacePixelateBatchCommand($this->imagine, $this->faceDetection, ...$this->toCommandArguments(...$options));
    }

    private function toCommandArguments(int $dimension): \Generator
    {
        yield $dimension;
    }
}
